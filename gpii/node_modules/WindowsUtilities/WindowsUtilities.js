 ...
 * Ejects USB drives
 *
 * @param {Array<String>} drivePaths - Array of drives to eject.
 */
gpii.windows.ejectUsbDrives = function (drivePaths) {
    ...
    fluid.each(drivePaths, function (path) {
 ...
 */
gpii.windows.openDirectories = function (paths) {
