...
fluid.defaults("gpii.processes.windows", {
    ...
    invokers: {
        ...
        getProcessPath: {
            funcName: "gpii.processes.windows.getProcessPath",
 ...
 */
gpii.processes.windows.getProcessPath = function (that, pid) {
    return gpii.windows.getProcessPath(pid);
};
...
gpii.processes.windows.getProcessList = function (processIdentifier) {
    ...
    fluid.each(procInfos, function (aProcInfo) {
        aProcInfo.argv = stringArgv.default(aProcInfo.commandLine);
