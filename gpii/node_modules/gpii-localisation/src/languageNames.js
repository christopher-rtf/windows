...
function getLanguageNames(langCode) {
    ...
    var codeHStr = ref.alloc(arch === "x64" ? "uint64" : "uint32");
    ...
    crtString.WindowsDeleteString(codeHStr.deref());
